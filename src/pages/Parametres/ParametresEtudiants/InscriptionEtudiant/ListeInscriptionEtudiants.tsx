...
import ListViewInscriptionsEtudiants from "./ListViewInscriptionsEtudiants";

const ListeInscriptionEtudiants = () => {
  document.title =
    "Liste Inscriptions Des Etudiants | Application Smart Institute";
    ...
    <React.Fragment>
      <div className="page-content">
        <Container fluid={true}>
          <Breadcrumb title="Paramètres Des Etudiants" pageTitle="Liste Inscriptions Des Etudiants" />
          {/* <Row>
                        <Col xxl={3} md={6}>
