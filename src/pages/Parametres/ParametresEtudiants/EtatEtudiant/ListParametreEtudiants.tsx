...
import ListViewParametresEtudiants from "./ListViewParametresEtudiants";

const ListParametresEtudiants = () => {
  document.title =
    "Liste Paramètres Des Etudiants | Application Smart Institute";
    ...
    <React.Fragment>
      <div className="page-content">
        <Container fluid={true}>
          <Breadcrumb title="Paramètres Des Etudiants" pageTitle="Liste Paramètres Des Etudiants" />
          {/* <Row>
                        <Col xxl={3} md={6}>
