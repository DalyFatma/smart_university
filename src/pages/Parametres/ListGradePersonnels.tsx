...
import ListViewGradePersonnels from "./ListViewGradePersonnels";



const ListGradePersonnels = () => {
  document.title =
    "Liste Grades Des Personnels | Application Smart Institute";
    ...
    <React.Fragment>
      <div className="page-content">
        <Container fluid={true}>
          <Breadcrumb title="Paramètres Des Personnels" pageTitle="Liste Grades Des Personnels" />
          {/* <Row>
                        <Col xxl={3} md={6}>
