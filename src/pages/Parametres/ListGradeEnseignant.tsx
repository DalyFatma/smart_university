...
import ListViewEtatEnseignants from "./ListViewGradeEnseignants";



const ListGradeEnseignants = () => {
  document.title =
    "Liste Grades Des Enseignants | Application Smart Institute";
    ...
    <React.Fragment>
      <div className="page-content">
        <Container fluid={true}>
          <Breadcrumb title="Paramètres Des Enseignants" pageTitle="Liste Grades Des Enseignants" />
          {/* <Row>
                        <Col xxl={3} md={6}>
