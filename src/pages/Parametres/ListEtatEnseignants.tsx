...
import ListViewEtatEnseignants from "./ListViewEtatEnseignants";



const ListEtatEnseignants = () => {
  document.title =
    "Liste états des enseignants | Smart University";
    ...
    <React.Fragment>
      <div className="page-content">
        <Container fluid={true}>
          <Breadcrumb title="Paramètres des enseignants" pageTitle="Liste états des enseignants" />
          {/* <Row>
                        <Col xxl={3} md={6}>
              ...
              >
                ...
                <Form className="tablelist-form">
                  <Modal.Body className="p-4">
                    ...
                    >
                      <Form.Label htmlFor="phone-field">حالة الأستاذ</Form.Label>
                      <Form.Control
                        type="text"
                        id="phone-field"
                        placeholder=""
