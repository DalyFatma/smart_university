...
import ListViewEtatPersonnels from "./ListViewEtatPersonnels";



const ListEtatPersonnels = () => {
  document.title =
    "Liste Etats Des Personnels | Application Smart Institute";
    ...
    <React.Fragment>
      <div className="page-content">
        <Container fluid={true}>
          <Breadcrumb title="Paramètres Des Personnels" pageTitle="Liste Etats Des Personnels" />
          {/* <Row>
                        <Col xxl={3} md={6}>
